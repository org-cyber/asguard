...
// GetModelsLoaded returns the ModelsLoaded field value if set, zero value otherwise.
func (o *HealthResponse) GetModelsLoaded() bool {
	if o == nil || IsNil(o.ModelsLoaded) {
		var ret bool
		return ret
	}
	return *o.ModelsLoaded
}

// GetModelsLoadedOk returns a tuple with the ModelsLoaded field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HealthResponse) GetModelsLoadedOk() (*bool, bool) {
	if o == nil || IsNil(o.ModelsLoaded) {
		return nil, false
	}
	return o.ModelsLoaded, true
}
...
// SetModelsLoaded gets a reference to the given bool and assigns it to the ModelsLoaded field.
...
func (o HealthResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ModelsLoaded) {
		toSerialize["models_loaded"] = o.ModelsLoaded
	}
	if !IsNil(o.Version) {
