...
conf = asguard.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("asguard")
        ...
        return [
            {
                ...
                'description': "Fraud Service (local)",
            },
            {
                'url': "http://localhost:8082",
                'description': "Face Service (local)",
            }
        ]
